...
func (fake *FakeDB) Exec(arg1 context.Context, arg2 string, arg3 ...interface{}) (pgconn.CommandTag, error) {
	fake.execMutex.Lock()
...
func (fake *FakeDB) ExecCalls(stub func(context.Context, string, ...interface{}) (pgconn.CommandTag, error)) {
	fake.execMutex.Lock()
...
func (fake *FakeDB) ExecReturns(result1 pgconn.CommandTag, result2 error) {
	fake.execMutex.Lock()
	defer fake.execMutex.Unlock()
	fake.ExecStub = nil
...
func (fake *FakeDB) ExecReturnsOnCall(i int, result1 pgconn.CommandTag, result2 error) {
	fake.execMutex.Lock()
	defer fake.execMutex.Unlock()
	fake.ExecStub = nil
...
func (fake *FakeDB) Query(arg1 context.Context, arg2 string, arg3 ...interface{}) (pgx.Rows, error) {
...
func (fake *FakeDB) QueryCalls(stub func(context.Context, string, ...interface{}) (pgx.Rows, error)) {
	fake.queryMutex.Lock()
...
func (fake *FakeDB) QueryReturns(result1 pgx.Rows, result2 error) {
	fake.queryMutex.Lock()
	defer fake.queryMutex.Unlock()
	fake.QueryStub = nil
...
func (fake *FakeDB) QueryReturnsOnCall(i int, result1 pgx.Rows, result2 error) {
	fake.queryMutex.Lock()
	defer fake.queryMutex.Unlock()
	fake.QueryStub = nil
...
func (fake *FakeDB) QueryRow(arg1 context.Context, arg2 string, arg3 ...interface{}) pgx.Row {
...
func (fake *FakeDB) QueryRowCalls(stub func(context.Context, string, ...interface{}) pgx.Row) {
	fake.queryRowMutex.Lock()
	defer fake.queryRowMutex.Unlock()
	fake.QueryRowStub = stub
}

func (fake *FakeDB) QueryRowArgsForCall(i int) (context.Context, string, []interface{}) {
	fake.queryRowMutex.RLock()
	defer fake.queryRowMutex.RUnlock()
...
func (fake *FakeDB) QueryRowReturns(result1 pgx.Row) {
	fake.queryRowMutex.Lock()
	defer fake.queryRowMutex.Unlock()
...
func (fake *FakeDB) QueryRowReturnsOnCall(i int, result1 pgx.Row) {
	fake.queryRowMutex.Lock()
	defer fake.queryRowMutex.Unlock()
	fake.QueryRowStub = nil
